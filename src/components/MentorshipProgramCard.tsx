...
export default function MentorshipProgramCard({
  ...
  return (
    ...
    >
      <div className="group relative flex flex-col rounded-2xl border border-border bg-white p-5 transition-all duration-200 hover:border-black/15 hover:shadow-[0_1px_6px_rgba(0,0,0,0.04)] dark:border-border-dark dark:bg-surface-dark-secondary dark:hover:border-white/10">
        {/* Title + Actions */}
